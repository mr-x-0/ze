...
COPYRIGHT = f"Ze {datetime.now().year}"
HEADER = f"""
ZE SOURCE
"""
...
print(
    f"""
{Fore.GREEN}-Thanks For Useing Ze Source

شكرا لاستخدامك سورس زد إي
. {Fore.RESET}
"""
)
...
sleep(0.2)
print(f"Use 'cd ze && python3 -m ze' to run Zs.{Fore.RESET}")
sleep(0.5)
print("\nFor help, join @ZESUPORT.")
sleep(0.5)
print("\nMade by @SOURCEZE.")
