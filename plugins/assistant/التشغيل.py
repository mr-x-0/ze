...
async def own(event):
    ...
    msg = message.format(
        mention=inline_mention(event.sender), me=inline_mention(zeubot.me)
    )
    if custom:
        msg += "\n\n۞ تم صنعه بواسطة: **@SOURCEZE**"
    await event.edit(
        msg,
