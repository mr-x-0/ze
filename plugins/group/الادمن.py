...
from ze.decorators import eod, eor
from resources import DEVLIST
from ze.helper import inline_mention, get_uinfo
from ze import HNDLR
from .. import LOGS, types, ze_cmd
...
@ze_cmd(pattern="تثبيت$", manager=True, require="pin_messages", fullsudo=True)
async def pin(msg):
    if not msg.is_reply:
